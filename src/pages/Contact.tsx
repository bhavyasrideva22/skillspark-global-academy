            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              <Card className="h-full card-hover">
                <CardContent className="p-6 h-full flex flex-col items-center text-center">
                  <div className="w-12 h-12 rounded-full bg-brand-purple bg-opacity-10 text-brand-purple flex items-center justify-center mb-4">
                    <MapPin size={24} />
                  </div>
                  <h3 className="text-xl font-semibold text-brand-dark mb-2">Our Location</h3>
              ...
              <Card className="h-full card-hover">
                <CardContent className="p-6 h-full flex flex-col items-center text-center">
                  ...
                  <h3 className="text-xl font-semibold text-brand-dark mb-2">Call Us</h3>
              ...
              <Card className="h-full card-hover">
                <CardContent className="p-6 h-full flex flex-col items-center text-center">
                  ...
                  <h3 className="text-xl font-semibold text-brand-dark mb-2">Email Us</h3>
                  <p className="text-gray-600 mb-2">
          ...
          <div className="container-section">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div className="h-full">
                <h2 className="text-2xl font-bold text-brand-dark mb-6">Find Us</h2>
                ...
                {submitted ? (
                  <Card className="h-full">
                    <CardContent className="p-8 h-full flex flex-col items-center justify-center text-center">
                      ...
                      <h3 className="text-xl font-semibold text-brand-dark mb-2">Message Sent!</h3>
                  ...
                  <Card className="h-full">
                    <CardContent className="p-6">
                      <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <Button 
                          type="submit" 
                          className="bg-brand-purple flex items-center"
            ...
            <div className="max-w-3xl mx-auto">
              <div className="space-y-6">
                <Card className="card-hover">
                  <CardContent className="p-6">
                    <h3 className="text-lg font-semibold text-brand-dark mb-2">How do I enroll in a course?</h3>
                    <p className="text-gray-600">
                ...
                <Card className="card-hover">
                  <CardContent className="p-6">
                    <h3 className="text-lg font-semibold text-brand-dark mb-2">Do you offer scholarships?</h3>
                    <p className="text-gray-600">
                ...
                <Card className="card-hover">
                  <CardContent className="p-6">
                    <h3 className="text-lg font-semibold text-brand-dark mb-2">What is the mode of training?</h3>
                    <p className="text-gray-600">
                ...
                <Card className="card-hover">
                  <CardContent className="p-6">
                    <h3 className="text-lg font-semibold text-brand-dark mb-2">How do I register for a hackathon?</h3>
                    <p className="text-gray-600">
                ...
                <Card className="card-hover">
                  <CardContent className="p-6">
                    <h3 className="text-lg font-semibold text-brand-dark mb-2">Do you provide placement assistance?</h3>
                    <p className="text-gray-600">
