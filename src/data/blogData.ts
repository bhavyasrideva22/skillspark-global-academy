...
export const blogPosts: BlogPost[] = [
  {
    ...
    readTime: 6,
    tags: ['ServiceNow', 'ITSM', 'Enterprise', 'Digital Transformation']
  },
  {
    id: 2,
    title: "Getting Started with Salesforce Lightning Components: A Beginner's Guide",
    slug: "salesforce-lightning-beginners-guide",
    excerpt: "Learn how to build your first Salesforce Lightning component with this step-by-step tutorial for beginners.",
    content: `
      <p>Salesforce Lightning Components have revolutionized how developers build on the Salesforce platform. This tutorial will walk you through creating your first Lightning component, even if you're completely new to Salesforce development.</p>
      
      <h2>What are Lightning Components?</h2>
      <p>Lightning Components are reusable UI elements that can be assembled to create responsive applications on the Salesforce platform. They use a component-based architecture similar to React or Angular, making them familiar to web developers.</p>
      ...
      <p>Before you can create Lightning Components, you need to set up your developer environment...</p>
      
      <h2>Step 2: Creating Your First Component</h2>
      <p>To create a Lightning component, navigate to the Developer Console and follow these steps...</p>
      
      <h2>Step 3: Adding Functionality with JavaScript</h2>
      <p>Lightning Components use JavaScript controllers to add functionality...</p>
      
      <h2>Step 4: Styling Your Component</h2>
      <p>You can add CSS styles to your component to customize its appearance...</p>
      
      <h2>Step 5: Testing and Deployment</h2>
      <p>Once your component is built, you'll want to test it thoroughly before deployment...</p>
      
      <h2>Common Mistakes to Avoid</h2>
      <p>As you begin working with Lightning Components, watch out for these common pitfalls:</p>
      <ul>
        <li>Forgetting to add access controls</li>
        <li>Not handling error states</li>
        <li>Overlooking mobile responsiveness</li>
      </ul>
      
      <h2>Next Steps</h2>
      <p>Now that you've built your first Lightning Component, consider these next steps to deepen your knowledge:</p>
      <ul>
        <li>Learn about Lightning Data Service</li>
        <li>Explore the Lightning Component Library</li>
        <li>Practice by building a more complex component</li>
      </ul>
      
      <p>At SkillSpark, our Salesforce Development courses cover Lightning Components in depth, providing hands-on labs and expert guidance to accelerate your learning journey.</p>
    `,
    category: 'tutorials',
    ...
    readTime: 8,
    tags: ['Salesforce', 'Lightning', 'Web Development', 'Tutorial']
  },
  {
    id: 3,
